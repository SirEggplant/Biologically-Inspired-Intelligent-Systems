...
print("Running Ackley's function...")
print("-----------------------------------")
...
for step_size in step_sizes:
    ...
    for T0 in initial_temps:
        ...
        std_f = np.std(trial_fitness, ddof=1)  # sample standard deviation
